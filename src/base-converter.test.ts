...
describe('convertFormBaseNToDecimal()', () => {
  ...
  describe('When given an invalid number in base N', () => {
    ...
    test('should throw an error indicating that there is more than one delimeter', () => {
...
describe('convertFormDecimalToBaseN()', () => {
  ...
  describe('When givben invalid parameters to the method', () => {
    test('should throw an error indicationg that the base needs to be an integer', () => {
      expect(() => converter.convertFromDecimalToBaseN(10, 45.56)).toThrowError('Base needs to be an integer');
    });
    test('should throw anerror indicating that the precision needs to be an integer', () => {
      expect(() => converter.convertFromDecimalToBaseN(10, 12, 12.56)).toThrowError('Precision needs to be an integer');
    });
    test('should throw anerror indicating that the number to convert needs to be an number', () => {
